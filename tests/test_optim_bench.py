"""Tests for the ``nanovllm_omni.bench`` harness (TK-011).
...
def _short_prompt():
    from nanovllm_omni.bench import BenchPrompt
...
def test_stage_times_non_negative():
    ...
    from nanovllm_omni.bench import run_one
...
def test_stage_times_has_cuda_fields_and_overhead():
    ...
    from nanovllm_omni.bench import StageTimes, run_one
...
def test_trace_profile_markdown_renders_table():
    from nanovllm_omni.bench.trace import (
        KernelStat,
        StageProfile,
        TraceProfile,
...
def test_seed_determinism():
    ...
    from nanovllm_omni.bench import BenchPrompt, run_one
...
def test_prompts_complete():
    ...
    from nanovllm_omni.bench import BENCH_PROMPTS, run_one
    from nanovllm_omni.models.minimind_omni import load_minimind_omni_bundle
