    ...
    pipeline = PipelineConfig(
        ...
        stages=(
            StageConfig(
                ...
                stage_factory=(smolvla_family + ".vlm_stage", "_vlm_stage"),
                process_input=None,
                input_sources=(),
                is_terminal=False,
            ),
            StageConfig(
                ...
                stage_factory=(smolvla_family + ".action_stage", "_action_stage"),
                process_input=(smolvla_family + ".stage_processors", "vlm2action"),
                input_sources=(0,),
                is_terminal=True,
